  ...
  return (
    <ThemeProvider theme={DarkTheme}>
      <Box>
        ...
        <Spaceman>
          <img src={astronaut} alt="spanceman" />
        </Spaceman>
        <Main>
          I'm a front-end developer located in VietName. I love to create simple
          yet beautiful websites with great user experience.
          <br />
          I'm interested in the whole frontend stack Like trying new things and
          building great projects.
          <br /> I am a senior student at UEF university. I really like to
          research and learn so that I can help businesses and the community.
